...
define('JCT_PATH_ROOT', $root_path . JCT_DE);

define('JCT_PATH_CORE', $root_path . JCT_DE . 'jct_core' . JCT_DE);
define('JCT_PATH_CORE_VENDORS', JCT_PATH_CORE . 'vendors' . JCT_DE);
...
/**
 * Absolute URLs
 * Note that the BASE tag is not used in the global site HEAD
 */
...
/**
 * Database SELECT, INSERT, UPDATE, DELETE connection
...
/**
 * Keep Activity records per User for this number of rows
 */
define('JCT_ACTIVITY_LIMIT', 1);
...
define('JCT_ALLOWABLE_FILE_MIMES', $tmp);
