    ...
    try
    {
        ...
        switch($action)
        {
            case('Test SMS'):
                ...
                $send_str = $auth_str . $numbers_stmt . '&text=' . urlencode($text);
    ...
    <form action="" method="post">  
        ...
        <legend>Account</legend>
            ...
            <label class="account-name">  
                ...
                <input type="text" name="account_name" value="databizcadoo" />
            </label><br/>
            ...
            <label class="numbers">  
                ...
                <input type="text" name="numbers" value="0867345627,0877761405,0863821397" style="display: block; width: 100%;" />
            </label> <br/>   
