...
try
{
    $source_path = JCT_PATH_ROOT . 'api' . JCT_DE . 'sample_data' . JCT_DE . 'tp_data' . JCT_DE . 'csvs' . JCT_DE . 'note_translations.csv';
    ...
    try
    {
        $db->query(" UPDATE tp_note SET title_ga_IE = :ir  WHERE title_en_GB = :en ");
