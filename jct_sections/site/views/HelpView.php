...
{
    function __construct(HelpModel $model)
    {
        parent::__construct();
        $this->model = $model;
    ...
    function index()
    {
        ...
        <div class="light-panel clearfix">
            ...
            <div class="preamble">
                ...
                <p style="text-align: left">Please request a Password by clicking on 'Request a New Password', and provide your email address and contact number. 
            ...
            <dl class="faqs">
                ...
                <dd>
                    Once you log in, click on the 'Account' link (top right of your screen) to update your password.
                </dd>
                <dt>Can I change my email?<i class="fa fa-chevron-down faq-expand" aria-hidden="true"></i></dt>
                <dd>
                    Once you log in, click on the 'Account' link (top right of your screen) to update your email address.
                </dd>
