...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            var hasOptGroup = ($(instance.element).find('optgroup').length > 0);
            ...
            // @DS set width here
            if(instance.options.width !== null)
                optionsWrap.css('width', instance.options.width);

            // @DS set width here
            if(instance.options.minWidth !== null)
                optionsWrap.css('min-width', instance.options.minWidth);
        ...
        _addOption: function( container, option ) {
            ...
            thisCheckbox.addClass('ms-checkbox');
